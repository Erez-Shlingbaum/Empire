...
Welcome to ``empire`` contributor's guide.
...
If you experience bugs or general issues with ``empire``, please have a look
...
You can help improve ``empire`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``empire`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``empire``'s files. While this mechanism can
...
or Miniconda_::
    ...
    conda create -n empire python=3 six virtualenv pytest pytest-cov
    conda activate empire
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/empire.git
    cd empire
...
#. Install |pre-commit|_::
   ...
   ``empire`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/empire
.. _issue tracker: https://github.com/<USERNAME>/empire/issues
.. <-- end -->
